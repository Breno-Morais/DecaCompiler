...
decac_moins_p=$(decac -p ../deca/context/valid/provided/hello-world.deca )
...
decac_moins_v=$(decac -v ../deca/context/valid/provided/hello-world.deca )
...
decac_moins_n=$(decac -n ../deca/context/valid/provided/hello-world.deca )
...
decac_moins_r=$(decac -r 5 ../deca/context/valid/provided/hello-world.deca )
...
decac_moins_d=$(decac -d ../deca/context/valid/provided/hello-world.deca )
